...
public class ProtocolSystem : MonoBehaviour
{
    ...
    private bool protocol_Activated = false; // 프로토콜을 작동 시킨적이 있나요?
    ...
    void Update()
    {
        ...
        if (protocol_Click)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                StabilityManager.Instance.StabilizationUp(StabilityManager.Instance.CurrentStability[i] * 0.15f, i);
            }
