...
public class TentacleVerletChain : MonoBehaviour, IChainPos
{
    ...
    public Vector3 flow = new Vector3(0.3f, 0.2f, 0.1f); // ���� �帧
    [Range(0f, 2f)] public float outwardBias = 0.0f;     // �ٱ����� ���� ����
    [Range(0.5f, 2f)] public float targetLenScale = 1f;  // ���� ���� ������(����ȭ ��)

    [Header("Clump / Blob SDF")]
    public Transform blobCenter;
    public float attractRadius = 0.22f;   // �߽ɺ� �ݰ�
    public float attractStrength = 6f;    // �߽� ����
    public float repelStrength = 8f;      // ���� ħ�� �� �ݹ�
    [Range(0f, 2f)] public float baseCurvature = 0.4f; // �⺻ ����(�� ����������)
    ...
    void Update()
    {
        ...
        //     ? transform.parent.InverseTransformDirection(flow)  // flow�� "����"��� ������ ��
        //     : flow;
        ...
        for (int i = 1; i < segments; i++)
        {
            ...
            // �� blobCenter�� �θ� ���÷� ��ȯ (�θ� null�̸� ���� position ���)
